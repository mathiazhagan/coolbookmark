    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="content" style="border:1px solid #9a9b9d;">
                ...
                <!-- left side start -->
                <div class="form2" style="margin-right:auto; margin-left:auto;float:none;">

                    <div class="t1"> Pegasus Business Sales: Immediate Sale From </div><br />

                    <img src="images/left-hr.png"/>	<br /><br />

                    <div class="t1"> Your Business Details <s:actionerror theme="jquery"/><s:actionmessage theme="jquery"/></div>						

                    <!-- form -->
                    <div class="sell_form"  >

                        <form  action="Adminlisting.action" method="post" >
                            ...
                            <div class="t1"> Business  Details</div>	<br />
                            <div class="t18"> Business Type<font color="red">*</font> </div>

                            <input type="text" name="BBusinessType" class="txt_bx" size="30" maxlength="100" value=""/>

                            <div class="t18"> Trading Days/Hours<font color="red">*</font> </div>

                            <input type="text" class="txt_bx" name="BTradingHours" size="30" maxlength="100" value=""/>



                            <div class="t18"> Sale Price<font color="red">*</font> </div>

                            <input type="text" class="txt_bx" name="BSalePrice" size="30" maxlength="100" value=""/>

                            <div class="t18"> Advert Heading<font color="red">*</font> </div>
                            ...
                            <textarea name="BBusinessDesc" maxlength="250" onkeyup="return ismaxlength(this)" class="input_box"></textarea><br/><br/>


                            <input type="submit" value="Save &amp; Continue" name="type" class="sub_button button"/>
