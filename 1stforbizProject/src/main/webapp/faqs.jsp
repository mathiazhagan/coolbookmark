            ...
            <div class="content" style="border:1px solid #9a9b9d;">
                ...
                <div class="form7">
                    ...
                    <div class="list02">
                        ...
                        <ul>
                            <li> <a href="faqs.jsp#1"> How do I go about finding the right business and determining how much it's worth? </a> </li>
                            <li> <a href="faqs.jsp#2"> Leasing Property vs. Buying </a> </li>
                            <li> <a href="faqs.jsp#3"> Community Express Loans </a> </li>
                            <li> <a href="faqs.jsp#4"> Is it better to own or lease business real estate? </a> </li>
                            <li> <a href="faqs.jsp#5"> How can I buy multifamily rentals or commercial real estate for investment? </a> </li>
                            <li> <a href="faqs.jsp#6"> Is there a simple way to do market research for a new business? </a> </li>
                            <li> <a href="faqs.jsp#7"> A Simplified Business Plan for an Internet Startup </a> </li>
                            <li> <a href="faqs.jsp#8"> What should I be aware of when buying a business? </a> </li>
                            <li> <a href="faqs.jsp#9"> What do I need to know about purchasing a franchise? </a> </li>
                            <li> <a href="faqs.jsp#10"> Is it possible to franchise my business? </a> </li>
                            <li> <a href="faqs.jsp#11"> How do I value my business? </a> </li>
                            <li> <a href="faqs.jsp#12"> Where can I get information about other businesses in the same industry? </a> </li>
                            <li> <a href="faqs.jsp#13"> Where can I get information about franchising? </a> </li>
                            <li> <a href="faqs.jsp#14"> What is the difference between purchasing a business Freehold or Leasehold? </a> </li>
                            <li> <a href="faqs.jsp#15"> I've found the business I want to buy but my bank have turned me down for a loan. What can I do? </a> </li>
                            <li> <a href="faqs.jsp#16"> What does SAV mean? </a> </li>
                            <li> <a href="faqs.jsp#17"> Is your service free to Buyers? </a> </li>
                            <li> <a href="faqs.jsp#18"> I've not bought a business before. How long does it take? </a> </li>
                            <li> <a href="faqs.jsp#19"> A business I am interested in is shown as "Under Offer". Why are you still advertising the business? </a> </li>
                ...
                <!-- right content start -->		
                <div class="right" style="margin:-5200px 0 0 850px">
