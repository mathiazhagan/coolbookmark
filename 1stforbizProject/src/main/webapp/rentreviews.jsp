...
<form method="post" action="searchbyref.action" >
            ...
            <div class="content" style="border:1px solid #9a9b9d;">
                ...
                <div class="about_us">
                    ...
                    <div class="t23">Rent Reviews </div><br />
                    <div class="list02"><ul>
                            <li>Professional rent review negotiations for Landlords and Tenants which resolve the matter in weeks, not months.</li>
                            <li>  Are you in a deadlock and need to resolve the matter fast? <a href="contactus.jsp" style="color: #6687a8;font-weight: bold" >Contact Us now</a>.</li>
                            <li>Lease Checkpoints</li>
                        </ul> 
                    </div>
                ...
                <!-- right content start -->		
                <div class="right" style="margin:-2900px 0 0 860px">
