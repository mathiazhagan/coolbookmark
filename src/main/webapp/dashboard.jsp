        ...
        <div id="container">
            <div id="containerbox">
                ...
                <div class="tableheader">
                    ...
                    <span class="Compaign">Post Time</span>
                    <span class="Compaign">Feed Type</span>
                ...
                <s:iterator  value="feedlist">
                    <div class="tabletext"  >
                        ...
                        <span class="Compaign"><s:property value="feedDesc" /></span>
                        <span class="Compaign"><s:property value="feedTime" /></span>
                        <span class="Compaign"><s:property value="feedType" /></span>
